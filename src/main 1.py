...
if RunMPC == 1:
    ...
    file_data = open(sys.path[0]+'/data/ClosedLoopDataLTI_MPC1.obj', 'w')
    pickle.dump(ClosedLoopDataLTI_MPC, file_data)
    file_data.close()
else:
    file_data = open(sys.path[0]+'/data/ClosedLoopDataLTI_MPC1.obj', 'r')
...
if RunLMPC == 1:
    ...
    file_data = open(sys.path[0]+'/data/LMPController1.obj', 'wb')
